...
imports = '''
{% from 'z/j2/figures.j2' import marginfig, fullfig, mainfig, inlinefig with context %}
{% from 'z/j2/diagrams.j2' import margindiag, fulldiag, maindiag with context %}
{% from 'z/j2/notes.j2' import marginnotes, spoileralert, codelink, hline with context %}
'''
