...
const lunr = require('../z/js/lunr-2.3.9.js');
...
//
// Go from "../posts/foo/bar/2016-12-18-Forensics-911-recovering-thesis.md"
...
const lunr_idx = lunr(function () {
    ...
    fnames.forEach(function (fname) {
        ...
        if (tags_str.includes('DRAFT') || tags_str.includes('HIDDEN')) {
            return;
        }
