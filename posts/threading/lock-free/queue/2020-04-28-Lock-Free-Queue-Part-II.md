...
{% call mainfig('reserve-race-condition.png') %}
...
{% call marginnotes() %} Or *compare and exchange* {% endcall %}
...
`__atomic_compare_exchange_n` will do it for us if it fails. {% endcall %}
...
{% call mainfig('ready-race-condition.png') %}
...
{{ fullfig('relativity-quantic-concurrent-programming.png') }}
