...
But when a friend of my opened his browser this week and went to ``google.com``
the things got odd.

The browser refused the connection warning me that the SSL certificate
...
They were tampering the internet access of all the company!{% marginfigure 'Big Brother sight' 'assets/isolate_wifi_big_brother_sight.png' '' %}
