...
def latexify(fig_width=None, fig_height=None, columns=1, usetex=True, **unused):
...
def show(save=None, context='paper', style='darkgrid', **kargs):
    ...
    if not _inside_of_a_show_and_save_context:
        ...
        sns.set(context, style, rc=latexify(**kargs))
